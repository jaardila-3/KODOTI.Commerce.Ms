...
namespace Identity.Service.EventHandlers
{
    public class UserLoginEventHandler : IRequestHandler<UserLoginCommand, IdentityAccess>
    {
        ...
        {
            var secretKey = _configuration.GetValue<string>("SecretKey"); //Microsoft.Extensions.Configuration.Binder
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddDays(1), //vencimiento del token
